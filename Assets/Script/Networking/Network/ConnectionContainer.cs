...
{
    /// <summary>
    ///     Holds a <see cref="Connection" /> instance and provides additional functionality. Holds
    ///     <see cref="TcpConnection" />s
    ///     and <see cref="UdpConnection" />s. Base class for all other connection containers. Provides the basic methods that
    ///     all
    ...
    public abstract class ConnectionContainer : IRSACapability
    {
        ...
        /// </summary>
        protected List<Assembly> KnownTypes { get; } = new List<Assembly>();
        ...
        ///     must be registered on each connection (these are found using reflection). NOTE: To avoid incompatible states
        ///     between
        ///     the server (<see cref="ServerConnectionContainer" />) and client (<see cref="ClientConnectionContainer" />), this
        ///     method
        ...
        ///     <see cref="ServerConnectionContainer" />)
        ///     and client (<see cref="ClientConnectionContainer" />), this method must be called on both sides before a connection
        ///     is established.
        /// </summary>
