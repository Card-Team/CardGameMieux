...
namespace Network.Packets
{
    ...
    ///     here: http://www.indie-dev.at/?page_id=461. NOTE: Inheriting classes should ALWAYS include the default
    ///     parameter-less
    ...
    ///     deserialisation, whose properties will be read from a <see cref="MemoryStream" />, deserialised and set
    ///     accordingly.
