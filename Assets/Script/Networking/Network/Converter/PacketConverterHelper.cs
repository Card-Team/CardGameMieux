...
namespace Network.Converter
{
    ...
    internal static class PacketConverterHelper
    {
        ...
        {
            return type?.Namespace?.Equals("System") ?? false;
        }
        ...
        {
            return property.PropertyType?.Namespace?.Equals("System") ?? false;
        }
        ...
        {
            var parameterlessConstructorExists =
            ...
            if (parameterlessConstructorExists) return Activator.CreateInstance(objectType);
