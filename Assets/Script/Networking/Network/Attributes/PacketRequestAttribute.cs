...
{
    /// <summary>
    ///     Maps a request packet to the response packet that handles it. This attribute should be placed on the response
    ///     packet
    ///     (must inherit from <see cref="ResponsePacket" />) and the <see cref="Type" /> of the <see cref="RequestPacket" />
    ///     that
    ...
    public class PacketRequestAttribute : Attribute
    {
        ...
        /// </summary>
        /// <param name="type">
        ///     The <see cref="Type" /> of the <see cref="RequestPacket" /> that the decorated <see cref="ResponsePacket" /> should
        ///     handle.
        /// </param>
