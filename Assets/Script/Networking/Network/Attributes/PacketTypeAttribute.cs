...
namespace Network.Attributes
{
    ...
    ///     attribute and set a unique id (UInt16). 2^16 (65536) unique ids are possible. Double usage of one id will lead to
    ///     an exception.
    ///     <list type="table">
    ///         <listheader>
    ///             <description>Following ids are already taken by the network lib:</description>
    ///         </listheader>
    ///         <item>
    ///             <term>00</term>
    ///             <description>
