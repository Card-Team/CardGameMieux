...
namespace Network.RSA
{
    ...
    public class SecureTcpConnection : TcpConnection
    {
        ...
        protected override UdpConnection CreateUdpConnection(IPEndPoint localEndPoint, IPEndPoint removeEndPoint,
            bool writeLock)
        {
            return new SecureUdpConnection(localEndPoint, removeEndPoint, RSAPair, writeLock);
        }
        ...
        /// </summary>
        private RSAConnection RSAConnection { get; }
